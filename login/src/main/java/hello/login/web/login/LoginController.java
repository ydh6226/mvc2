...
//    @PostMapping("/login")
    public String loginV2(@Valid LoginForm form, BindingResult result, HttpServletResponse response) {
        if (result.hasErrors()) {
            return "login/loginForm";
        }
...
//    @PostMapping("/login")
    public String loginV3(@Valid LoginForm form, BindingResult result, HttpServletRequest request) {
        if (result.hasErrors()) {
            return "login/loginForm";
        }
    ...
    @PostMapping("/login")
    public String loginV4(@Valid LoginForm form, BindingResult result, HttpServletRequest request,
